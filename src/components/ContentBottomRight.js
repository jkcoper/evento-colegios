...
function ContentBottomRight(){
    return(
        <div className="detalle">
            ...
            <h2 className="titulo2">Trabajando en equipo podemos lograr.</h2>
            Trabajar en "PROYECTO DE VIDA" de sus estudiantes, para que estos a su vez se conviertan en emprendedores y generadores de riqueza, mejorando la calidad de vida de sus familias y la sociedad.
